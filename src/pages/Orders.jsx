            ...
            <div key={index} className='py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center justify-between gap-4'>
              <div className='flex items-start gap-6 text-sm'>
                ...
                <div>
                  ...
                  <p className='mt-2'>Date: <span className='text-gray-400'>20th September 2024</span></p>
                </div>
              </div>
              ...
              <div className='md:w-1/2 flex justify-between'>
                ...
                <button className='bg-black text-white px-3 py-2 rounded-sm font-medium'>TRACK ORDER</button>
              </div>
            </div>
          ))
        }
